# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 13:14:29 2021
...
'''
d = r"C:\Users\imoge\OneDrive\Documents\Fourth Year\Project\Imogen\GitHub\slm\images\2021\November\08\Measure 7"
...
class profile():
    ...
    def analyseBeamProfile(self, fit = 'linear', plot_all=False,crop_x=None,crop_y=None,angle=None):
    ...
    def plotZ(self, fit = True):
        ...
        plt.figure(figsize=(10,4))
        plt.plot(z, wx, marker = 'o', linestyle = 'none', color = '#AA2B4A', label = 'Plot of z vs wx')
        plt.plot(z, wy, marker = 'o', linestyle = 'none', label = 'Plot of z vs wy')
