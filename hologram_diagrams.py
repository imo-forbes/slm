...
amplitude = [ 4.34738453e-01,  2.97358849e-03, -1.03608071e-02, -7.53345542e-03,
       -7.22903243e-04, -4.35512934e-03,  7.83893365e-03,  7.60637623e-03,
       -2.99139295e-02,  2.93378198e-02,  1.02432726e-02,  4.35653943e-02,
        4.86483014e-03,  4.20554341e-03,  1.23038112e-04]
...
for i in range(len(radial)):
    holo = zernike(radial = radial[i], azimuthal = azimuthal[i], amplitude= amplitude[i], radius = None, shape=(512,512))
